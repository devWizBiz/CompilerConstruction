...
def test_tokenize_valid_content():
    ...
    sample_tokens = {
        ...
        16: {'COL': 10, 'LINE': 4, 'TOKEN': 't_VarTwo', 'TYPE': 'IDENTIFIER'},
        17: {'COL': 19, 'LINE': 4, 'TOKEN': '=', 'TYPE': 'PUNCTUATORS'},
        18: {'COL': 21, 'LINE': 4, 'TOKEN': "'c'", 'TYPE': 'CHAR_CONSTANT'},
        19: {'COL': 24, 'LINE': 4, 'TOKEN': ';', 'TYPE': 'PUNCTUATORS'},
        20: {'COL': 5, 'LINE': 5, 'TOKEN': 'char', 'TYPE': 'KEYWORD'},
        21: {'COL': 10, 'LINE': 5, 'TOKEN': 't_var3', 'TYPE': 'IDENTIFIER'},
        22: {'COL': 16, 'LINE': 5, 'TOKEN': '[', 'TYPE': 'PUNCTUATORS'},
        23: {'COL': 17, 'LINE': 5, 'TOKEN': ']', 'TYPE': 'PUNCTUATORS'},
        24: {'COL': 19, 'LINE': 5, 'TOKEN': '=', 'TYPE': 'PUNCTUATORS'},
        25: {'COL': 21, 'LINE': 5, 'TOKEN': '"Hello, this is a string"', 'TYPE': 'STRING_CONSTANT'},
        26: {'COL': 46, 'LINE': 5, 'TOKEN': ';', 'TYPE': 'PUNCTUATORS'},
